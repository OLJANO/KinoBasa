<form action = "/movies/create" method = "post">
	...
	<textarea class = "form-control input-lg" name = "discriptions"  placeholder = "описание"></textarea> <br>
	...
	<input class = "form-control input-lg" type = "input" name = "category_id" placeholder = "категария(1= фильм; 2=сериал)"><br>
