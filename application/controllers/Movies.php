 ...
 * 
 */
class Movies extends NY_Controller {
	...
	public function type($slug = NULL) {
		...
		$p_config['frist_tag_open'] = "<li>";
		$p_config['frist_tag_close'] = "</li>";
		$p_config['last_tag_open'] = "<li>";
		$p_config['last_tag_close'] = "</li>";

		//init pagination
		$this->pagination->initalize($p_config);
	...
	public function edit($slug = NULL) {
		...
		$this->['movies_item'] = $this-> Films_model-> getMovies($slug);
